...
const Ware = () => {
    ...
    const [InfoWare, setInfoWare] = useState([]);
    let token = Cookies.get("102365");
    useEffect(() => {
      showData("GET", token, "/warehouse/carwarehouse/")
        .then((resultinfo) => {
          setInfoWare(resultinfo.data);
  ...
  return (
    ...
    <div className="  bg-gray-700">
      ...
      <h2 className="text-gray-100 text-3xl font-light p-1 flex  items-center justify-center ">Warehose</h2>
      <DatatebleWare info={InfoWare}/>
      </div>
    </div>
  </main>
  )
